...
##----  1. OPSCR models ----
rm(list=ls())
setwd("C:/My_documents/rovquant/analyses/Rgit/RovQuantPublic/technicalReports/fagrapport101_Wolverine2015-2024/input/OPSCR")

# load the sex-specific input data
# Females
load("53.aJ_FaCleaned2024Chain1.RData")
# Males
