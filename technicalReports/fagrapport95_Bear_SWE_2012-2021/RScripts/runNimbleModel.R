...
##-- MINA fagrapport 95 - "Estimates of brown bear density, abundance and
...
##-- (located in fagrapport95_Bear_SWE_2012-2021/RScripts)
source("technicalReports/fagrapport95_Bear_SWE_2012-2021/RScripts/dbinomLocal_normalCovs.R")
source("technicalReports/fagrapport95_Bear_SWE_2012-2021/RScripts/dcatHR.R")
source("technicalReports/fagrapport95_Bear_SWE_2012-2021/RScripts/sampler_categorical_general1.R")


##-- Load Male or Female data input
##-- (located in fagrapport95_Bear_SWE_2012-2021/input)
...
##-- This step is needed only for OPSCR models that use dead recoveries data
##-- (i.e. "OPSCR_DR_..._input_1.RData" and"OPSCR_DR_reg_..._input_1.RData" input files)
##-- Skip for other input files
