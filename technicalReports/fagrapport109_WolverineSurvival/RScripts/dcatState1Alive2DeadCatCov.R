...
#' 
#'
#' The \code{dcatState1Alive2DeadCatCov} distribution is a NIMBLE custom distribution which can be used to model and simulate
...
#' 
#' @name dcatState1Alive2DeadCatCov 
#' 
...
#' @return 
#' \code{dcatState1Alive2DeadCatCov} gives the (log) probability density of \code{x}. 
...
#'    
#' dcatState1Alive2DeadCatCov(  x = zPlusOne
#'                      , z = z
#'                      , prob1To2 = prob1To2
#'                      , prob2To3 = prob2To3
#'                      , prob2To4 = prob2To4
...
dcatState1Alive2DeadCatCov  <- nimbleFunction(run = function( x = double(0)
  ...
  if(z == 2){
    ...
    #prob2To3
    if(prob2To3== -999){
      indProb2To3HR <- exp(prob2To3Hab[prob2To3HabCov[sID]] + betaDens[1] * densCov[sID])
      indProb2To4HR <- exp(prob2To4Hab[prob2To4HabCov[sID]] + betaDens[2] * densCov[sID])
      indProb2To2 <- exp(-(indProb2To3HR+indProb2To4HR)) #1 - ( indProb2To3 + indProb2To4)
      indProb2To3 <- (1 - indProb2To2) * (indProb2To3HR/(indProb2To3HR + indProb2To4HR))
      indProb2To4 <- (1 - indProb2To2) * (indProb2To4HR/(indProb2To4HR + indProb2To3HR))
...
#' 
#### 2.Sampling function ####
rcatState1Alive2DeadCatCov <- nimbleFunction(run = function( n = integer(0)
                                                             , z = double(0)
                                                             , prob1To2 = double(0, default=-999)
                                                             , prob1To2Hab = double(1)
                                                             , prob2To3 = double(0, default=-999)
...
registerDistributions(list(
  dcatState1Alive2DeadCatCov = list(
    BUGSdist = "dcatState1Alive2DeadCatCov(z, prob1To2       , prob1To2Hab    , prob2To3       , prob2To3Hab    ,prob2To3HabCov, prob2To4       , prob2To4Hab    ,prob2To4HabCov, densCov, betaDens, s, habitatGrid)",
    ...
    Rdist = c( "dcatState1Alive2DeadCatCov(z, prob1To2       , prob1To2Hab = s, prob2To3       , prob2To3Hab = s,prob2To3HabCov, prob2To4       , prob2To4Hab = s,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2       , prob1To2Hab = s, prob2To3       , prob2To3Hab = s,prob2To3HabCov, prob2To4 = -999, prob2To4Hab    ,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2       , prob1To2Hab = s, prob2To3 = -999, prob2To3Hab    ,prob2To3HabCov, prob2To4 = -999, prob2To4Hab    ,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2       , prob1To2Hab = s, prob2To3 = -999, prob2To3Hab    ,prob2To3HabCov, prob2To4       , prob2To4Hab = s,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2 = -999, prob1To2Hab    , prob2To3       , prob2To3Hab = s,prob2To3HabCov, prob2To4       , prob2To4Hab = s,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2 = -999, prob1To2Hab    , prob2To3       , prob2To3Hab = s,prob2To3HabCov, prob2To4 = -999, prob2To4Hab    ,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2 = -999, prob1To2Hab    , prob2To3 = -999, prob2To3Hab    ,prob2To3HabCov, prob2To4 = -999, prob2To4Hab    ,prob2To4HabCov, densCov, betaDens, s , habitatGrid)",
               "dcatState1Alive2DeadCatCov(z, prob1To2 = -999, prob1To2Hab    , prob2To3 = -999, prob2To3Hab    ,prob2To3HabCov, prob2To4       , prob2To4Hab = s,prob2To4HabCov, densCov, betaDens, s , habitatGrid)"
    ),
    types = c( "value = double(0)", "z = double(0)","prob1To2 = double(0)", "prob1To2Hab = double(1)", "prob2To3 = double(0)",
               "prob2To3Hab = double(1)" , "prob2To3HabCov = double(1)" ,"prob2To4 = double(0)", "prob2To4Hab = double(1)","prob2To4HabCov = double(1)","densCov = double(1)","betaDens =  double(1)",
