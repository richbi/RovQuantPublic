...
##----  1. OPSCR models ----
rm(list=ls())
setwd("C:/My_documents/rovquant/analyses/Rgit/RovQuantPublic/technicalReports/fagrapport97_Wolves2014-2024/input/OPSCR")

# load the sex-specific input data
# Females
load("36.F_2023_sf_INPUTChain1.RData")
# Males
#load("36.M_2023_sf_INPUTChain1.RData")
